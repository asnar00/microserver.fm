...
@feature class _Device extends _Feature {
    @def stub() : boolean { fm.log("inside stub, returning", true); return true; }
...
@feature export class _Files extends _Feature {
    @def load(filename: string): string { fm.log("not implemented"); return ""; }
    @def save(filename: string, text: string) { fm.log("not implemented"); }
}
