...
function test_test() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    _a = test_js_1._output;
                    return [4 /*yield*/, add(10, 5)];
                case 1:
                    _a.apply(void 0, [_d.sent(), 26]); //@ 26
                    _b = test_js_1._assert;
                    return [4 /*yield*/, add(10, 5)];
                case 2:
                    _b.apply(void 0, [_d.sent(), 15, 30]); //@ 30
                    _c = test_js_1._assert;
                    return [4 /*yield*/, add(10, 5)];
                case 3:
                    _c.apply(void 0, [_d.sent(), 16, 34]); //@ 34
                    return [2 /*return*/];
            }
        });
    });
